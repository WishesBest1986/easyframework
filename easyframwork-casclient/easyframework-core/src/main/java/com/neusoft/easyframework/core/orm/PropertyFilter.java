package com.neusoft.easyframework.core.orm;

import com.neusoft.easyframework.utils.ConvertUtils;
import com.neusoft.easyframework.utils.ServletUtils;
...
public class PropertyFilter {
    ...
    public PropertyFilter(final String filterName, final String value) {
        ...
        Assert.isTrue(StringUtils.isNotBlank(propertyNameStr), "filter名称" + filterName + "没有按规则编写,无法得到属性值类型.");
