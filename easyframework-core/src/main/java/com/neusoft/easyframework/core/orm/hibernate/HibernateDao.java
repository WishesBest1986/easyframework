package com.neusoft.easyframework.core.orm.hibernate;

import com.neusoft.easyframework.core.orm.Page;
import com.neusoft.easyframework.core.orm.PropertyFilter;
import com.neusoft.easyframework.utils.ReflectionUtils;
...
public class HibernateDao<T, PK extends Serializable> extends SimpleHibernateDao<T, PK> {
    ...
    protected long countCriteriaResult(final Criteria criteria) {
        ...
        try {
            orderEntries = (List) ReflectionUtils.getFiledValue(impl, "orderEntries");
